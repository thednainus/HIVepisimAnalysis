...
results_phylo <- subset(all_phyloscanner_results, mig == "250migrants" & param == "1067" & rep == 16)
results_phylo["reps_groups"] <- paste(results_phylo$mig,
                                      results_phylo$param,
                                      results_phylo$rep,
                                      sep = "_")


all_phyloscanner_results <- readRDS("all_phyloscanner_results_test1.RDS")
