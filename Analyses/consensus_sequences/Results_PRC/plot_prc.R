...
sampler1_1067_500mig %>%
  ...
  theme_bw() +
  ggtitle("PRC curves for Parameters 1 (sampler 1 and 500 migrants)") +
...
sampler1_2348_500mig %>%
  ...
  facet_wrap(~ perc, scales = "free", ncol = 5) +
  theme_bw() +
  ggtitle("PRC curves for Parameters 2 (sampler 1 and 500 migrants)") +
  labs(y = 'Precision', x = 'Recall') +
  theme(text = element_text(size = 20), legend.position = "bottom") +
  scale_colour_manual(values = c('#ad0075', '#9fc439', '#0187d3'),
                      name = 'Tree type',
...
sampler1_1067_250mig %>%
  ...
  facet_wrap(~ perc, scales = "free", ncol = 5) +
  theme_bw() +
  ggtitle("PRC curves for Parameters 1 (sampler 1 and 250 migrants)") +
  labs(y = 'Precision', x = 'Recall') +
  theme(text = element_text(size = 20), legend.position = "bottom") +
  scale_colour_manual(values = c('#ad0075', '#9fc439', '#0187d3'),
                      name = 'Tree type',
...
sampler1_2348_250mig %>%
  ...
  facet_wrap(~ perc, scales = "free", ncol = 5) +
  theme_bw() +
  ggtitle("PRC curves for Parameters 2 (sampler 1 and 250 migrants)") +
...
sampler1_1067_750mig %>%
  ...
  facet_wrap(~ perc, scales = "free", ncol = 5) +
  theme_bw() +
  ggtitle("PRC curves for Parameters 1 (sampler 1 and 750 migrants)") +
  labs(y = 'True positive rate', x = 'False positive rate') +
  theme(text = element_text(size = 20), legend.position = "bottom") +
  scale_colour_manual(values = c('#ad0075', '#9fc439', '#0187d3'),
                      name = 'Tree type',
...
sampler1_2348_750mig %>%
  ...
  facet_wrap(~ perc, scales = "free", ncol = 5) +
  theme_bw() +
  ggtitle("PRC curves for Parameters 2 (sampler 1 and 750 migrants)") +
  labs(y = 'True positive rate', x = 'False positive rate') +
  theme(text = element_text(size = 20), legend.position = "bottom") +
  scale_colour_manual(values = c('#ad0075', '#9fc439', '#0187d3'),
                      name = 'Tree type',
...
sampler2_1067_500mig %>%
  ...
  facet_wrap(~ perc, scales = "free", ncol = 5) +
  theme_bw() +
  ggtitle("PRC curves for Parameters 1 (sampler 2 and 500 migrants)") +
  labs(y = 'True positive rate', x = 'False positive rate') +
  theme(text = element_text(size = 20), legend.position = "bottom") +
  scale_colour_manual(values = c('#ad0075', '#9fc439', '#0187d3'),
                      name = 'Tree type',
...
sampler2_2348_500mig %>%
  ...
  facet_wrap(~ perc, scales = "free", ncol = 5) +
  theme_bw() +
  ggtitle("PRC curves for Parameters 2 (sampler 2 and 500 migrants)") +
  labs(y = 'True positive rate', x = 'False positive rate') +
  theme(text = element_text(size = 20), legend.position = "bottom") +
  scale_colour_manual(values = c('#ad0075', '#9fc439', '#0187d3'),
                      name = 'Tree type',
...
sampler2_1067_250mig %>%
  ...
  facet_wrap(~ perc, scales = "free", ncol = 5) +
  theme_bw() +
  ggtitle("PRC curves for Parameters 1 (sampler 2 and 250 migrants)") +
  labs(y = 'True positive rate', x = 'False positive rate') +
  theme(text = element_text(size = 20), legend.position = "bottom") +
  scale_colour_manual(values = c('#ad0075', '#9fc439', '#0187d3'),
                      name = 'Tree type',
...
sampler2_2348_250mig %>%
  ...
  facet_wrap(~ perc, scales = "free", ncol = 5) +
  theme_bw() +
  ggtitle("PRC curves for Parameters 2 (sampler 2 and 250 migrants)") +
  labs(y = 'True positive rate', x = 'False positive rate') +
  theme(text = element_text(size = 20), legend.position = "bottom") +
  scale_colour_manual(values = c('#ad0075', '#9fc439', '#0187d3'),
                      name = 'Tree type',
...
sampler2_1067_750mig %>%
  ...
  facet_wrap(~ perc, scales = "free", ncol = 5) +
  theme_bw() +
  ggtitle("PRC curves for Parameters 1 (sampler 2 and 750 migrants)") +
  labs(y = 'True positive rate', x = 'False positive rate') +
  theme(text = element_text(size = 20), legend.position = "bottom") +
  scale_colour_manual(values = c('#ad0075', '#9fc439', '#0187d3'),
                      name = 'Tree type',
...
sampler2_2348_750mig %>%
  ...
  facet_wrap(~ perc, scales = "free", ncol = 5) +
  theme_bw() +
  ggtitle("PRC curves for Parameters 2 (sampler 2 and 750 migrants)") +
  labs(y = 'True positive rate', x = 'False positive rate') +
  theme(text = element_text(size = 20), legend.position = "bottom") +
  scale_colour_manual(values = c('#ad0075', '#9fc439', '#0187d3'),
                      name = 'Tree type',
