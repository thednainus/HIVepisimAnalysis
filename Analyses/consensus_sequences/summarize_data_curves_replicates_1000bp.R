#summarize data for maximum likelihood trees reconstructed with 1000bp
#to plot ROC or PRC for consensus sequences
...
merge_label_data <- function(list_dirs, code, sampler){
  ...
  for(i in 1:length(list_dirs)){
    ...
    filename <- list.files(paste(list_dirs[i], "output/vts/alignments/W_estimated", sep = "/"),
                           pattern = paste(code, "W_labels", sep = "_"),
                           full.names = TRUE)
...
saveRDS(all_data_s1_250mig, "all_data_s1_1000bp_250mig_threshold0.90.RDS")
...
saveRDS(all_data_s1_500mig, "all_data_s1_1000bp_500mig_threshold0.90.RDS")
...
saveRDS(all_data_s1_750mig, "all_data_s1_1000bp_750mig_threshold0.90.RDS")
...
saveRDS(all_data_s2_250mig, "all_data_s2_1000bp_250mig_threshold0.90.RDS")
...
saveRDS(all_data_s2_500mig, "all_data_s2_1000bp_500mig_threshold0.90.RDS")
...
saveRDS(all_data_s2_750mig, "all_data_s2_1000bp_750mig_threshold0.90.RDS")
